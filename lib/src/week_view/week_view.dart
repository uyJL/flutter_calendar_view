...
class WeekViewState<T extends Object?> extends State<WeekView<T>> {
  ...
  void initState() {
    ...
    _fullDayHeaderTextConfig = widget.fullDayHeaderTextConfig ?? FullDayHeaderTextConfig();
  }
                ...
                child: DecoratedBox(
                  ...
                  child: SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (_, index) {
                        // var dates = DateTime(_minDate.year, _minDate.month,
                        ...
                        return ValueListenableBuilder(
                          ...
                          builder: (_, __, ___) => InternalWeekViewPage<T>(
                            key: ValueKey(_hourHeight.toString() + widget.dates[0].toString()),
                            height: _height,
                            width: _width,
                            ...
                            showLiveLine: widget.showLiveTimeLineInAllDays ||
                                _showLiveTimeIndicator(widget.dates),
  ...
  void _regulateCurrentDate() {
    ...
    widget.getCurrentPage(_currentIndex);
  }
  ...
  void _onPageChange(int index) {
    if (mounted) {
      setState(() {
        ...
        _currentEndDate = _currentStartDate.add(Duration(days: 3));
        _currentIndex = index;
      });
    }
